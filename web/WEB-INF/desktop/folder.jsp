...
<stripes:layout-render name="/WEB-INF/share/base.jsp">
<stripes:layout-component name="body">
<%@include file="/WEB-INF/share/inbox_header.jsp" %>
<%@include file="/WEB-INF/share/navigation.jsp" %>
<%@include file="/WEB-INF/javascript/folder.js" %> 
...
<table width="100%">
                            ...
                            <tr>
                                <td width="100%" height="25" align="left" valign="top" bgcolor="#eeeeee">
                                    ...
                                    <stripes:link beanclass="pm.matthews.webmail.action.FolderAction" event="listMessages">
                                        ...
                                        <b>${fn:escapeXml(folder.getName())}</b>
                                    </stripes:link>    
                                    <em><label>${folder.getMessageCount()}</label></em>
                                    </font>                       
                                </td>     
                            </tr>
                        </core:if>
 ...
 <stripes:messages/>   
<%@include file="/WEB-INF/share/trash.jsp" %>    
