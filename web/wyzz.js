...
var buttonName = new Array("font");

// Order of available commands in toolbar2
// Remove from this any buttons not required in your application
var buttonName2 = new Array("font","separator","bold","italic","underline","strikethrough","separator","cut","copy","paste","separator","subscript","superscript","separator","justifyleft","justifycenter","justifyright","separator","insertunorderedlist","separator","link","insertimage","separator","specialchar","separator","forecolor","backcolor","separator","inserthorizontalrule","separator","upsize","downsize","separator","htmlmode","separator","undo","redo");
...
function make_wyzz(textareaID) {
  var wyzzW = parseInt(document.getElementById(textareaID).cols* 8.1);
  var wyzzH = parseInt(document.getElementById(textareaID).rows*13);
  // Hide the textarea 
