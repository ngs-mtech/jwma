...
public class MessageAction extends BaseAction implements ValidationErrorHandler{
    ...
    public Resolution cycleMessages(){
        ...
        msg = dm.messageDetails();
        return new ForwardResolution("/WEB-INF/desktop/readmessage.jsp");        
    }
    ...
    public Resolution displayMessage(){
        ...
        DisplayMessage dm = new DisplayMessage(store, folder, number, processor);
        updateMailSession();
        String view = "/WEB-INF/mobile/readmessage.jsp";
        msg = dm.messageDetails(); 
        if(!jession.mobile){ 
            ...
            else{view = "/WEB-INF/desktop/readmessage.jsp";}
        }
    ...
    public Resolution switchToHtml(){
        ...
        msg = dm.messageDetails();
        String view = "/WEB-INF/desktop/readmessage.jsp";
        if(jession.mobile){view = "/WEB-INF/mobile/readmessage.jsp";}
        return new ForwardResolution(view);
    }
    ...
    public Resolution printMessage(){
        ...
        return new ForwardResolution("/WEB-INF/desktop/printmessage.jsp");
    }
    ...
    public Resolution forward(){
        ...
        String view = "/WEB-INF/desktop/sendmessage.jsp";
        if(jession.mobile){view = "/WEB-INF/mobile/sendmessage.jsp";}
        return new ForwardResolution(view);
    }
