...
public class InitAction extends BaseAction{
    ...
    public Resolution init(){
        ...
        String ua = getContext().getRequest().getHeader("User-Agent").toLowerCase();
    ...
    public Resolution desktop(){
        lastLogin = setLoginName();
        return new ForwardResolution("/WEB-INF/desktop/login.jsp");
    }
    
    public Resolution mobile(){
        lastLogin = setLoginName();
        return new ForwardResolution("/WEB-INF/mobile/login.jsp");
    }
}
